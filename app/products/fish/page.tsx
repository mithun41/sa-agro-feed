    ...
    <div className="min-h-screen bg-gray-50 mt-24 pb-20">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-cyan-700 to-sky-600 text-white py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          >
            <p className="text-sm md:text-base font-semibold text-cyan-100 mb-3 uppercase tracking-[0.2em]">
              Call Now
            </p>
            ...
            <motion.a
              ...
              className="bg-cyan-600 text-white px-10 py-5 rounded-2xl font-black text-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-all border-b-4 border-cyan-400 active:border-b-0 active:translate-y-1 inline-block hover:bg-cyan-700 hover:shadow-[0_25px_60px_rgba(0,0,0,0.3)]"
            >
              {phoneNumber}
            </motion.a>
          </motion.div>
