...
export default function CattleDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 mt-24 pb-20">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-red-900 via-red-700 to-red-600 text-white py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          >
            <p className="text-sm md:text-base font-semibold text-red-100 mb-3 uppercase tracking-[0.2em]">
              Call Now
            </p>
            ...
            <motion.a
              ...
              className="bg-red-600 text-white px-10 py-5 rounded-2xl font-black text-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-all border-b-4 border-red-400 active:border-b-0 active:translate-y-1 inline-block hover:bg-red-700 hover:shadow-[0_25px_60px_rgba(0,0,0,0.3)]"
            >
              {phoneNumber}
            </motion.a>
          </motion.div>
      ...
      <section className="mt-20 px-6">
        <div className="max-w-5xl mx-auto bg-black rounded-[2rem] p-12 text-center relative overflow-hidden shadow-2xl border border-red-600/30">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
              যেকোনো তথ্যের জন্য আমাদের কল করুন
            </h2>
            <a
              href={`tel:${phoneNumber}`}
              className="inline-flex items-center gap-4 bg-red-700 text-white px-12 py-5 rounded-2xl text-2xl font-black hover:bg-red-600 transition-all shadow-xl hover:scale-105"
            >
              কল করুন এখন
            </a>
          </div>
